    ...
    <div className="bg-slate-50">
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              {/* application logo and white gradient overlay */}
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                <img src="/snake-1.png" alt="snake-logo" className="w-full" />
              </div>
              {/* application heading */}
              <h1 className="relative w-fit tracking-tight mt-16 font-bold text-balance !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{" "}
              ...
              {/* Customers image and review rating and counting of customers */}
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          {/* snake-png and heading container */}
      ...
      {/* about application section what it is do */}
      <section>
